...
<required_reading>
@C:/The Brain/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/The Brain/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/The Brain/.claude
                  → checks C:/The Brain/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/The Brain/.claude/get-shit-done
                  → writes to C:/The Brain/.claude/get-shit-done/hooks/
...
@C:/The Brain/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/The Brain/.claude/get-shit-done/references/common-bug-patterns.md
