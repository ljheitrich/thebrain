...
<reference>
@C:/The Brain/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/The Brain/.claude/get-shit-done/references/user-profiling.md` to load:
