...
<execution_context>
@C:/The Brain/.claude/get-shit-done/workflows/list-workspaces.md
@C:/The Brain/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @C:/The Brain/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
