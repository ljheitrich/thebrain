...
```markdown
Read C:/The Brain/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/The Brain/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/The Brain/.claude/agents/gsd-ui-checker.md for instructions.
