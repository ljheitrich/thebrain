...
```
Task(
  prompt="Read C:/The Brain/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/The Brain/.claude/get-shit-done/templates/SECURITY.md`
