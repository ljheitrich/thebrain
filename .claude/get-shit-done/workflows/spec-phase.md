...
```bash
INIT=$(node "C:/The Brain/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/The Brain/.claude/get-shit-done/templates/spec.md.
